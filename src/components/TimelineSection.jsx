...
/* ─── 3D Tilt Card ───────────────────────────────────────────────── */
function TiltCard({ children, style, disableTilt = false }) {
  const ref = useRef(null);
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        perspective: disableTilt ? "none" : 1000,
        position: "relative",
        overflow: "hidden",
        ...style,
      }}
...
function TimelineSection({
  ...
  const timelineProgress = useTransform(
    scrollY,
    [sectionTop - window.innerHeight * 0.5, sectionTop + sectionHeight],
    [0, 1]
  );
    ...
    >
      ...
      >
        ...
        <div style={{ position: "relative" }}>
          {/* Main Vertical Timeline Line with SVG */}
          <svg
            style={{
              position: "absolute",
          ...
          >
            <defs>
              <linearGradient
                ...
                y2="100%"
              >
                <stop offset="0%" stopColor="#06363c" stopOpacity="0.2" />
                <stop offset="50%" stopColor="#1a5c3a" stopOpacity="0.2" />
                <stop offset="100%" stopColor="#2a4a7f" stopOpacity="0.2" />
              </linearGradient>
              <linearGradient
                id="activeLine"
                x1="0%"
                ...
                y2="100%"
              >
                <stop offset="0%" stopColor="#06363c" stopOpacity="0" />
                <stop offset="50%" stopColor="#1a5c3a" stopOpacity="1" />
                <stop offset="100%" stopColor="#2a4a7f" stopOpacity="0" />
              </linearGradient>
            </defs>

            {/* Static background line */}
            <line x1="0" y1="0" x2="0" y2="100%" stroke="url(#timelineGradient)" strokeWidth="2" />
            ...
            <motion.line
              ...
              style={{
                strokeDasharray: "100%",
                strokeDashoffset: useTransform(timelineProgress, (v) => `${(1 - v) * 100}%`),
              }}
              strokeLinecap="round"
              filter="drop-shadow(0 0 6px rgba(6,54,60,0.4))"
            />
          </svg>
          ...
          <motion.div
            style={{
              y: useTransform(timelineProgress, (v) => `${v * 100}%`),
            }}
            animate={{
              opacity: [0, 1, 0],
            }}
          ...
          <motion.div
            style={{
              y: useTransform(timelineProgress, (v) => `calc(${v * 100}% - 13px)`),
            }}
            initial={false}
            style={{
              position: "absolute",
              left: isMobile ? "7px" : "27px",
              top: "0",
              width: "26px",
              height: "26px",
              borderRadius: "50%",
              ...
              boxShadow: "0 0 20px rgba(6,54,60,0.6)",
              zIndex: 3,
            }}
          >
            <motion.div
              ...
              style={{
                ...
                inset: "-8px",
                borderRadius: "50%",
                border: "2px solid rgba(6,54,60,0.3)",
              }}
            />
          </motion.div>
          ...
          >
            {storyItems && storyItems.length > 0 ? (
              storyItems.map((item, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <motion.div
                          animate={{
                            scale: [1, 1.3, 1],
                            opacity: itemInView ? [0.4, 0.8, 0.4] : [0.1, 0.2, 0.1],
                          }}
                          transition={{
                            duration: 2,
                            repeat: Infinity,
                      ...
                      <motion.div
                        animate={{
                          scale: itemInView ? [1, 1.08, 1] : 1,
                          boxShadow: itemInView
                            ? [
                                `0 4px 12px ${item.color}30`,
                                `0 8px 20px ${item.color}50`,
                                `0 4px 12px ${item.color}30`,
                              ]
                            : `0 2px 8px rgba(0,0,0,0.05)`,
                        }}
                        transition={{
                          duration: itemInView ? 2 : 0.3,
                          repeat: itemInView ? Infinity : 0,
                        }}
                        style={{
                          fontSize: "10px",
                          fontWeight: 700,
                      ...
                      <motion.div
                        animate={{
                          scaleX: itemInView ? 1 : 0,
                          opacity: itemInView ? 1 : 0.3,
                        }}
                        transition={{ duration: 0.6 }}
                        style={{
                          position: "absolute",
                          top: isMobile ? "50%" : "50%",
                          right: isMobile ? "-32px" : "-52px",
                          width: isMobile ? "30px" : "50px",
                          height: "2px",
                          background: itemInView
                    ...
                    {/* Card Content */}
                    <GlowCard glowColor={item.color} style={{ flex: 1 }}>
                      <motion.div
                        whileHover={
                          !isMobile
                            ? {
                      ...
                      >
                        {/* Highlight background on scroll */}
                        <motion.div
                          animate={{
                            opacity: itemInView ? 0.5 : 0,
                          }}
              ...
              <p style={{ textAlign: "center", color: "#999" }}>No story items available</p>
            )}
          </div>
        </div>
      </div>
...
export default function AboutPage() {
  ...
  const diffGridCols = isMobile ? 1 : isTablet ? 2 : 3;
  const teamGridCols = isMobile ? 1 : isTablet ? 1 : 2;
  const credGridCols = isMobile ? 2 : isTablet ? 2 : 4;
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Particle Field */}
        <ParticleField count={isMobile ? 10 : 20} color="#06363c" />
        ...
        >
          ...
          <motion.div
            ...
            style={{
              ...
              gap: isMobile ? "12px" : isTablet ? "16px" : "16px",
            }}
          >
            {stats.map((stat, i) => (
              <TiltCard key={i} disableTilt={isMobile}>
                <motion.div
                  variants={fadeUp}
                  whileHover={
                    !isMobile
                      ? { y: -8, boxShadow: "0 20px 40px rgba(6,54,60,0.12)" }
                      : {}
                  }
                  style={{
      ...
      {/* ═══════════ SECTION 2 — STORY (Enhanced Timeline) ═══════════ */}
      <TimelineSection
        isMobile={isMobile}
        isTablet={isTablet}
        slideLeft={slideLeft}
      ...
      >
        <div style={{ maxWidth: "1160px", margin: "0 auto" }}>
          ...
          <motion.div
            ...
            style={{
              display: "grid",
              gridTemplateColumns: `repeat(${diffGridCols}, 1fr)`,
              gap: isMobile ? "16px" : "24px",
            }}
          >
      ...
      >
        <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
          ...
          <motion.div
            ...
            style={{
              display: "grid",
              gridTemplateColumns: `repeat(${credGridCols}, 1fr)`,
      ...
      >
        <div style={{ maxWidth: "900px", margin: "0 auto" }}>
          ...
          >
            ...
            <ParticleField count={isMobile ? 6 : 12} color="#7ecfc0" />
            ...
            >
              ...
              >
                ...
                >
                  View Services
                  <FiExternalLink size={isMobile ? 14 : 17} />
                </motion.a>
              </motion.div>

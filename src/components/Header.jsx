...
const Header = () => {
  ...
  const navLinks = [
    ...
    { name: "CPA Firm's", path: "/cpa-firms" },
    { name: "Blog", path: "/blog" },
  ];
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-[#f5f5f5]/80 supports-[backdrop-filter]:bg-[#f5f5f5]/60 backdrop-blur-md  border-gray-200">

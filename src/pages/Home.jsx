    ...
    <div className="w-full bg-[#f5f5f3]">
      ...
      <section className="relative overflow-hidden bg-[#f5f5f3] pt-2 pb-12">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          ...
          <div className="hidden lg:block">
            ...
            <div className="absolute left-[200px] top-[130px]">
              <div className="w-14 h-14 rounded-full border border-[#0d3d43] flex items-center justify-center bg-white shadow-sm">
                <ArrowUpRight size={24} className="text-[#0d3d43]" />
              </div>
            </div>
            ...
            <div className="absolute left-[260px] top-[175px]">
              <div className="w-11 h-11 rounded-full bg-[#dff5b7] flex items-center justify-center shadow-sm">
                <BadgeCheck size={17} className="text-[#0d3d43]" />
              </div>
            </div>
            ...
            <div className="absolute right-[180px] top-[65px]">
              <div className="w-11 h-11 rounded-full bg-[#dff5b7] flex items-center justify-center shadow-sm">
                <BarChart3 size={17} className="text-[#0d3d43]" />
              </div>
            </div>
          ...
          >
            <div id="pin-windmill" className="flex items-center justify-center">
              <div
                id="pin-windmill-svg"
              ...
              >
                ...
                <div className="relative w-7 h-7">
                  <TbNorthStar size={28} className="text-[#0d3d43]" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="text-center max-w-5xl mx-auto">
            ...
            >
              ...
              <br />
              with <span className="text-[#0d3d43]">Latest Technology</span>
            </motion.h1>
            ...
            <div className="mt-3 flex flex-col items-center">
              ...
              <p className="mt-1 text-[#6b6b6b] text-[15px]">
                from 80+{" "}
                <span className="underline text-[#171717]">reviews</span>
              </p>
            </div>
          </div>
            ...
            >
              <div className="flex items-center justify-between">
                <div className="-mt-2 w-11 h-11 rounded-xl bg-[#dff5b7] flex items-center justify-center">
                  <BadgeCheck size={20} className="text-[#0d3d43]" />
                </div>

                <MoreVertical size={20} className="text-[#8b8b8b]" />
              </div>

              <p className="mt-4 text-[#707070] text-[16px]">Total Projects</p>
              ...
              <p className="mt-2 text-[#8b8b8b] text-[14px] leading-6">
                Increase of{" "}
                <span className="text-[#77c255] font-medium">126</span> this
                month
              </p>
            </motion.div>
          ...
          >
            ...
            >
              ...
              <div className="mt-10">
                ...
                <p className="mt-5 text-[#c0d0d1] text-[16px] leading-7">
                  Procedures and systems in place to ensure high product
                  quality.
                </p>
              </div>
            </motion.div>
              ...
              <div className="relative w-full max-w-[560px] min-h-[500px] bg-[#efefed] rounded-[38px] p-10 overflow-hidden">
                  ...
                  <div className="mt-12 space-y-7">
                    ...
                    <div>
                      <div className="flex items-center justify-between text-[15px] text-[#7a7a7a] mb-2">
                        <span>Finished</span>
                        <span className="text-[#171717] font-medium">10%</span>
                      </div>
                    ...
                    <div>
                      <div className="flex items-center justify-between text-[15px] text-[#7a7a7a] mb-2">
                        ...
                        <span className="text-[#171717] font-medium">13%</span>
                      </div>
                    ...
                    <div>
                      <div className="flex items-center justify-between text-[15px] text-[#7a7a7a] mb-2">
                        <span>Rejected</span>
                        <span className="text-[#171717] font-medium">11%</span>
                      </div>
                ...
                >
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <div className="text-[#8b8b8b] text-[24px]">⋮</div>
                  </div>
                  ...
                  <div className="mt-7">
                    ...
                    <p className="mt-5 text-[#8a8a8a] text-[16px]">
                      Increase of{" "}
                      <span className="text-[#42c07d] font-medium">126</span>{" "}
                      this month
                    </p>
                  </div>
                </motion.div>

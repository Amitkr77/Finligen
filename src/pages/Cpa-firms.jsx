  ...
  return (
    ...
    <section className="relative py-32 bg-white overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 relative z-10">
        ...
        {/* COMPARISON GRID */}
        <div className="mt-20 grid lg:grid-cols-2 gap-8 items-stretch">
    ...
    {/* ─────────────────── STATS SECTION ─────────────────── */}
    <section className="relative py-32 overflow-hidden bg-[#0d3d43]">
...
//             >
//               Most offshore accounting
//               relationships fail for the
//               same reason.
//             </h2>

//             <p
//               className="mt-8 text-[#666]
//                         text-[18px]
//                         leading-[1.9]
//                         max-w-3xl"
//             >
...
//                 <div
//                   key={i}
//                   className="flex gap-4 bg-[#f8f8f6]
//                             rounded-2xl p-6"
//                 >
...
//       {/* STATS */}
//       <section className="py-24 bg-[#0d3d43] overflow-hidden">
...
//                 key={i}
//                 whileHover={{ y: -6 }}
//                 className="bg-white border border-[#e8e8e6]
//                           rounded-[28px] p-7"
//               >
//                 <div
//                   className="w-14 h-14 rounded-2xl
...
//                 >
//                   Delivered using your workflow,
//                   formatting standards, and review process.
//                 </p>
//               </motion.div>
//             ))}
...
//                         leading-[1.9]"
//             >
//               We’re not sending random files back and forth.
//               FinliGen works inside structured CPA delivery systems —
//               with documented workflows, review layers,
//               turnaround targets, and communication standards.
//             </div>
...
//                 key={i}
//                 whileHover={{ y: -6 }}
//                 className="bg-white border border-[#e7e7e5]
//                           rounded-[30px]
//                           p-8"
//               >
...
//       {/* BUSY SEASON */}
//       <section className="py-28 bg-[#0d3d43] overflow-hidden">
...
//                           font-semibold"
//               >
//                 Busy season shouldn’t
//                 feel like survival mode.
//               </h2>
...
//                           max-w-3xl"
//               >
//                 We operate with strict internal access controls,
//                 NDA-protected teams, encrypted document systems,
...
//       {/* FINAL CTA */}
//       <section className="py-28 bg-[#0d3d43]">
